...
const Register = () => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            const res = await axios.post("https://pantone.onrender.com/api/v1/auth/signup", formData);
        ...
        className="sm:w-1/3 bg-cyan-500 text-gray-500 p-2 rounded">
            ...
            <div>
                <label htmlFor="password">
                    ...
                    <div>
                        <button className="w-full p-2 rounded bg-rose-500 text-cyan-500 mt-2 transition hover:bg-white">
                            Register
                        </button>
                    </div>
        </form>
