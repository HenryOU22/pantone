...
const Login = () => {
    ...
    <form className="max-w-xs shadow-lg rounded p-5"
    ...
    <p className="text-xs text-center text-slate-600">Don&rsquo;t have an account? Register <Link to='/register'>here</Link></p>
    </div>
